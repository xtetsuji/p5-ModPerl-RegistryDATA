...
ModPerl::PerlRunDATA - Can read __DATA__ section ModPerl::Registry* family.

=head1 Synopsis

  # httpd.conf
  PerlModule ModPerl::PerlRunDATA
  Alias /perl-run/ /home/httpd/perl/
  <Location /perl-run>
      SetHandler perl-script
      PerlResponseHandler ModPerl::PerlRunDATA
...
This modules is compatible of L<ModPerl::PerlRun>.

But L<ModPerl::PerlRun> trashes "__DATA__ section".
This module L<ModPerl::PerlRunDATA> is insert "__DATA__ section"
to DATA filehandle.
